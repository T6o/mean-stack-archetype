...
angular.module('map').factory('MapService', ['$resource', function($resource, $rootScope, $http, $location, $scope, Authentication) {
...
/*
  ...
  var convertToMapPoints = function(response){
      ...
      for(var i= 0; i < response.data.length; i++) {
          ...
          var  contentString = '<p><b>Lat</b>: ' + article.location[1] + '<br><b>Lng</b>: ' + article.location[0] + '<br>' +
              '<b></b>: ' + "article.field" +'</p>';

          // Converts each of the JSON records into Google Maps Location format (Note Lat, Lng format).
          locations.push(new Location(
              new google.maps.LatLng(article.location[1], article.location[0]),
